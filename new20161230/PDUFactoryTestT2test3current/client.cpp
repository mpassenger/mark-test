...
//------------------@jack to add outlet power off--------------------------------
        ...
        for(i=0;i<3;i++)
        {
                if(i==0)
                {
                        if((CheckBox1->Checked == true&&EU->Checked == true)|| (CheckBox4->Checked == true&&US->Checked == true))
                        {
                ...
                if(i==1)
                {
                        if((CheckBox2->Checked == true&&EU->Checked == true) || (CheckBox5->Checked == true&&EU->Checked == true))
                        {
                                if(EU->Checked == true)
                                {
                                        char eucurr2_cmd[] = {0x63,0x75,0x72,0x72,0x20,0x35,0x2E,0x37,0x0A,'\r'};
                                        //  memset(RxdBuffer, NULL, sizeof(RxdBuffer));
                                        WriteFile(COM1, eucurr2_cmd, 10, &dw_Write, 0);
                                        //  ReadFile(COM1, &RxdBuffer, 1024, &dw_Read, NULL);
                                        ::Sleep(1000);
                                        Application->ProcessMessages();
                                        I=5.7;
                                        ...
                                        a=P*(1+0.08);
                                        b=P*(1-0.08);
                                        //Application->MessageBox("2","show");
                                 }
                                if(US->Checked == true)
                                {
                                        char eucurr2_cmd[] = {0x63,0x75,0x72,0x72,0x20,0x38,0x2E,0x37,0x0A,'\r'};
                                        //  memset(RxdBuffer, NULL, sizeof(RxdBuffer));
                                        WriteFile(COM1, eucurr2_cmd, 10, &dw_Write, 0);
                                        //  ReadFile(COM1, &RxdBuffer, 1024, &dw_Read, NULL);
                                        ::Sleep(1000);
                ...
                if(i==2)
                {
                        if((CheckBox3->Checked == true&&EU->Checked == true) || (CheckBox6->Checked == true&&EU->Checked == true))
                        {
                                if(EU->Checked == true)
                                {
                                        char eucurr3_cmd[] = {0x63,0x75,0x72,0x72,0x20,0x39,0x2E,0x37,0x0A,'\r'};
                                        WriteFile(COM1, eucurr3_cmd, 10, &dw_Write, 0);
                                        ::Sleep(1000);
                                        Application->ProcessMessages();
                                        I=9.7;
                                        n=I*(1+0.05);
...
void Open_File()
{
        ...
        memset(Firmware,0,5);
        GetPrivateProfileString("PDU-TEST","Firmware"," ",Firmware,5,filepath.c_str());
        memset(PE_08I,0,2);
                ...
                if(strcmp(f29,s)==0&&strcmp(f,f1)!=0&&strcmp(f,f2)!=0&&strcmp(f,f3)!=0&&strcmp(f,f4)!=0&&strcmp(f,f5)!=0&&strcmp(f,f6)!=0&&strcmp(f,f7)!=0&&strcmp(f,f8)!=0
                   ...
                   &&strcmp(f,f28)!=0&&strcmp(f,f29)!=0&&strcmp(f,f30)!=0&&strcmp(f,f31)!=0)
                   {
                     ...
                     //   Application->MessageBox(result.c_str(),"show");
                        ...
                        {
                                Application->MessageBox("PE-08Ilog上傳成功","show");
                                TelnetForm->Button1->Enabled = true;
                        }
                        else
                        {
                                TelnetForm->Button1->Enabled = false;
                                Application->MessageBox("PE-09Nlog上傳成功","show");
                        }
                       // Application->MessageBox(Url.c_str(),"show");
